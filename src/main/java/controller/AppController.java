...
public class AppController {
    ...
    private double confidenceLevel = 0.05;
    ...
    private void calculationData() {
        ...
        if (selectedOptions[9]) {
            String input = JOptionPane.showInputDialog(view, "Введите уровень доверия (например, 0.05 для 5%):", "Ввод уровня доверия", JOptionPane.QUESTION_MESSAGE);
            ...
            saveData(results, resultText, selectedOptions, covariances);
            view.getOutputArea().setText(resultText.toString()); 
    }

    private void saveData(List<Result> results, StringBuilder resultText, boolean[] selectedOptions, List<Double> covariances) {
            ...
            if (option == JFileChooser.APPROVE_OPTION) {
                ...
                try (Workbook workbook = new XSSFWorkbook();
                    ...
                    for (int i = 0; i < results.size(); i++) {
                        ...
                        setRow(result, confidenceInterval, row);
                    }
